...
const Layout = ({ children }) => (
  ...
  <>
    ...
    <div className="social-bar">
		...
		<a href="www.linkedin.com/in/rodrigo-se-mx" className="icon icon-linkedin" target="_blank"></a>
		<a href="mailto:rodrigosantacruz42@gmail.com" className="icon icon-mail" target="_blank"></a>
